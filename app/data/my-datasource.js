angular.module(PKG.name+'.services')
  ...
  .factory('MyDataSource', function ($rootScope, caskWindowManager, mySocket, MYSOCKET_EVENT, $q, $filter, MyPromise, myHelpers, myUrlService) {
    ...
    DataSource.prototype.poll = function (resource, cb, errorCb) {
      ...
      var promise = new MyPromise(function(resolve, reject) {
        ...
        if (!resource.url) {
          generatedResource.url = buildUrl(myU.constructUrl(resource), resource.params || {});
        } else {
    ...
    DataSource.prototype.request = function (resource, cb) {
      ...
      var promise = new MyPromise(function(resolve, reject) {
        ...
        if (!resource.url) {
          generatedResource.url = buildUrl(myUrlService.constructUrl(resource), resource.params || {});
        } else {
          generatedResource.url = buildUrl(resource.url, resource.params || {});
        }
